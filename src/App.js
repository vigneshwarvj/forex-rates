...
const App = () => {
  ...
  const apiUrl = 'https://api.1forge.com/quotes?pairs=EUR/USD,GBP/USD,USD/JPY,AUD/USD,CAD/USD,CHF/USD,NZD/USD,EUR/GBP,EUR/JPY,USD/TRY&api_key=L3U43ksbgZzMghC9UtvVH60oJxtVMjtp';  // Insert your API URL here
