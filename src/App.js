...
const App = () => {
  ...
  const apiUrl = 'https://api.1forge.com/quotes?pairs=EUR/USD,GBP/USD,USD/JPY,AUD/USD,CAD/USD,CHF/USD,NZD/USD,EUR/GBP,EUR/JPY,XAU/USD&api_key=API_KEY';  // Insert your API URL here
